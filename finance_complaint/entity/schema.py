...
class FinanceDataSchema:
    def __init__(self):
        ...
        self.col_submitted_via: str = 'submitted_via'
    ...
    def derived_input_features(self) -> List[str]:
        features = [self.col_date_sent_to_company, self.col_date_received]
        return features
    ...
    @property
    def im_numerical_features(self) -> List[str]:
        return [f"im_{col}" for col in self.numerical_features]

    @property
    def tfidf_features(self) -> List[str]:
        features = [self.col_issue]
        return features
    ...
    def input_features(self) -> List[str]:
        in_features = self.tf_one_hot_encoding_features + self.im_numerical_features + self.tf_tfidf_features
        return in_features
